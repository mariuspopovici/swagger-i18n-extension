...
function translate(object, language) {
  if (typeof object !== "object") {
    throw new Error(
      "Passed swagger schema must be object. Not `" + typeof object + "`"
    );
  }
      ...
      if (matches) {
        ...
        if (typeof subject[fieldName] !== "string") {
          throw new Error(
            "Field `" +
              ...
              "` at `" +
              path +
              "` must be filled and being string"
          );
        }
        ...
        if (typeof value[language] === "undefined") {
          throw new Error(
            "Field `" +
              path +
              "` does not contain language translation `" +
              language +
              "`"
          );
        }
        if (typeof value[language] !== "string") {
          throw new Error(
            "Field at `" + path + "." + language + "` must be string "
          );
        }
